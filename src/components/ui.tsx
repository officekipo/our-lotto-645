...
export const styles = StyleSheet.create({
  ...
  prizeCopy: { flex: 1, minWidth: 0, paddingRight: Dimensions.get('window').width <= 340 ? 0 : 16 },
  ...
  prizeMetaBox: { width: Dimensions.get('window').width <= 340 ? '100%' : 128, alignItems: 'flex-start', flexShrink: 0, marginLeft: Dimensions.get('window').width <= 340 ? 0 : 16 },
  ...
  roundSelector: { height: 64, paddingHorizontal: Dimensions.get('window').width <= 340 ? 16 : 28, backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#EEF1F4' },
  ...
  bottomNav: { width: '100%', height: Dimensions.get('window').width <= 600 ? 66 : 84, minHeight: Dimensions.get('window').width <= 600 ? 66 : 84, paddingHorizontal: Dimensions.get('window').width <= 600 ? 10 : 14, paddingTop: Dimensions.get('window').width <= 600 ? 4 : 8, paddingBottom: Dimensions.get('window').width <= 600 ? 4 : 10, backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', borderTopWidth: 1, borderTopColor: '#EEF1F4', borderTopLeftRadius: 22, borderTopRightRadius: 22 },
  navItem: { flex: 1, height: Dimensions.get('window').width <= 600 ? 52 : 64, alignItems: 'center', justifyContent: 'center', borderRadius: 18, marginHorizontal: 2 },
  navItemActive: { backgroundColor: 'transparent' },
  navIconWrap: { width: Dimensions.get('window').width <= 600 ? 30 : 38, height: Dimensions.get('window').width <= 600 ? 24 : 32, borderRadius: Dimensions.get('window').width <= 600 ? 8 : 11, alignItems: 'center', justifyContent: 'center' },
  navIconWrapActive: { backgroundColor: 'transparent' },
  navLabel: { marginTop: Dimensions.get('window').width <= 600 ? 2 : 6, fontSize: Dimensions.get('window').width <= 600 ? 10 : 11, lineHeight: 15, fontWeight: '800', color: '#667386' },
