...
export const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: Dimensions.get('window').width <= 340 ? 16 : 28, backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#EEF1F4' },
